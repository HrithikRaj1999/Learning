...
def render(
    ...
    try:
        ...
        print("Run: cd /home/charles/Documents/Codes/Learning/SystemDesign/HLD/.claude/skills/excalidraw-diagram/references && python3 -m venv .venv && ./.venv/bin/pip install 'playwright>=1.40.0' && ./.venv/bin/playwright install chromium", file=sys.stderr)
        sys.exit(1)
    ...
    with sync_playwright() as p:
        try:
            ...
            if "Executable doesn't exist" in str(e) or "browserType.launch" in str(e):
                ...
                print("Run: cd /home/charles/Documents/Codes/Learning/SystemDesign/HLD/.claude/skills/excalidraw-diagram/references && ./.venv/bin/playwright install chromium", file=sys.stderr)
                sys.exit(1)
            raise
