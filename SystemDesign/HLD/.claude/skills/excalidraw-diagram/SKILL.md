...
**Setup:** Renderer already installed at `/home/charles/Documents/Codes/Learning/SystemDesign/HLD/.claude/skills/excalidraw-diagram/references/.venv` (python venv + playwright chromium). Render with `./.venv/bin/python render_excalidraw.py <file>` from that `references` dir — do NOT use `uv`.

**Where diagrams go:** save `.excalidraw` files under `/home/charles/Documents/Codes/Learning/SystemDesign/HLD/` (create a `diagrams/` subfolder per topic).
...
```bash
cd /home/charles/Documents/Codes/Learning/SystemDesign/HLD/.claude/skills/excalidraw-diagram/references && ./.venv/bin/python render_excalidraw.py <path-to-file.excalidraw>
```
...
```bash
cd /home/charles/Documents/Codes/Learning/SystemDesign/HLD/.claude/skills/excalidraw-diagram/references
python3 -m venv .venv && ./.venv/bin/pip install "playwright>=1.40.0"
